...
namespace MaidService
{
    public partial class UserRegistration : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                //Validation
                Regex uname= new Regex(@"^(?=.{8,20}$)(?![_.])(?!.*[_.]{2})[a-zA-Z0-9._]+(?<![_.])$");
                Regex nid;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string sqll = "select Username from [User] where Username='" + this.txtUsername.Text + "';";
                        ...
                        else
                        {
                            ...
                            conn.Open();
                            string query = "";
                            query = "INSERT INTO [User] (Username,Name,Nid,Email,Gender,Phone,Password,Address,Question,Answer) VALUES('" + txtUsername.Text + "','" + txtName.Text + "','" + txtNid.Text + "','" + txtEmail.Text + "','" + gender + "','" + txtPhone.Text + "','" + txtPassword.Text + "','" + richTxtAddress.Text + "','" + comboQuestion.Text + "','" + txtAnswer.Text + "')";
                            string query1 = "";
                            query1 = "INSERT INTO [Login] (Username,Password,Status) VALUES ('" + txtUsername.Text + "','" + txtPassword.Text + "','User')";
        ...
        void Clear()
        {
            txtUsername.Text = txtName.Text = txtNid.Text = txtEmail.Text = txtPhone.Text = txtPassword.Text = richTxtAddress.Text = comboQuestion.Text = txtAnswer.Text = "";
        ...
        private void comboQuestion_LocationChanged(object sender, EventArgs e)
        {
